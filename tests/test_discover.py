...
class DiscoverTests(unittest.TestCase):
    def test_classify_page_type_contact_and_official(self) -> None:
        self.assertEqual(
            classify_page_type("https://example.org/government/first-selectman", "First Selectman"),
            "official_page",
        )
        self.assertEqual(
    ...
    def test_select_contact_child_links_same_domain_only(self) -> None:
        ...
        selected = select_contact_child_links(links, municipality_domain="townct.gov", max_links=10)
